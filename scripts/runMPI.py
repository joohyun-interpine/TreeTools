...
if __name__ == '__main__':
    ...
    """
    # point_clouds_to_process = directory_mode(r'G:\Ministry_of_Primary_Industries\Current\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\TreeTools')
    ...
    #                           #   # r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P08\Hovermap\02_UnclassifiedPoints_EN\P042P08_UNC_E_N.laz',
    #                            r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P09\Hovermap\02_UnclassifiedPoints_EN\P042P09_UNC_E_N.laz',
    #                           # #  r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P11\Hovermap\02_UnclassifiedPoints_EN\P042P11_UNC_E_N.laz',
    #                           #  r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P12\Hovermap\02_UnclassifiedPoints_EN\P042P12_UNC_E_N.laz',
    #                           #  r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P13\Hovermap\02_UnclassifiedPoints_EN\P042P13_UNC_E_N.laz',
    #                           #  r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P14\Hovermap\02_UnclassifiedPoints_EN\P042P14_UNC_E_N.laz',
    #                            r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P24\Hovermap\02_UnclassifiedPoints_EN\P042P24_UNC_E_N.laz',
    #                           #   # r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P25\Hovermap\02_UnclassifiedPoints_EN\P042P25_UNC_E_N.laz',
    #                           #   r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P26\Hovermap\02_UnclassifiedPoints_EN\P042P26_UNC_E_N.laz',
    #                             r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P27\Hovermap\02_UnclassifiedPoints_EN\P042P27_UNC_E_N.laz',
    #                             r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P31\Hovermap\02_UnclassifiedPoints_EN\P042P31_UNC_E_N.laz',
    #                             r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P35\Hovermap\02_UnclassifiedPoints_EN\P042P35_UNC_E_N.laz',
    #                           #   # r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P36\Hovermap\02_UnclassifiedPoints_EN\P042P36_UNC_E_N.laz']
    #                             r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P37\Hovermap\02_UnclassifiedPoints_EN\P042P37_UNC_E_N.laz',
    #                             r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P38\Hovermap\02_UnclassifiedPoints_EN\P042P38_UNC_E_N.laz',
    #                             r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P41\Hovermap\02_UnclassifiedPoints_EN\P042P41_UNC_E_N.laz',
    #                           #   # r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P41\Hovermap\02_UnclassifiedPoints_EN\P042P42_UNC_E_N.laz',
    #                             r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Sent_Data\P042_Canterbury\P042P45\Hovermap\02_UnclassifiedPoints_EN\P042P45_UNC_E_N.laz']

    # project = r'U:\MPI_J7634_Measure_Carbon_Stock_Changes\Plot_Datasets\P042_Canterbury'
    # filelist = glob.glob(f"{project}\\**\*_E_N.laz", recursive='True')
    # point_clouds_to_process = [name for name in filelist if ("Archive" not in name)]
    # with open(f'{project}\\filelist.txt', 'w') as outfile:
    #   outfile.write('\n'.join(i for i in point_clouds_to_process))

    SCAN = 'MLS' # "MLS" for hovermap, "ALS" for drone, 
    # main parameters to change according to type of scan
    if SCAN == 'ALS':
      scan_param_dict ={"denoise_stem_points":False, 
      ...
      scan_param_dict={"denoise_stem_points":True, 
                       ...
                       "SOR_filter" : True, # applies Statistical outlier removal on the slices of stem points
                        ...
                        "subsample":0,
                        "headers":['x', 'y', 'z', 'intensity','return_number','Range']
                          }
