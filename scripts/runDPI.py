...
if __name__ == '__main__':
    ...
    if SCAN == 'ALS':
      ...
      scan_param_dict={"denoise_stem_points":True, 
                          "tree_base_cutoff_height":3.1, # to ignore unassigned branches
                          "max_search_radius":2, # search radius (in metres) for interpolation
                          "gap_connect":.4, # used in dbscan to connect skeleton points into tree skeleton
