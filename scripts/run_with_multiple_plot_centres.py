...
if __name__ == '__main__':
    ...
    """
    point_clouds_to_process = [['E:/your_point_cloud1.laz', [your_plot_centre_X_coord, your_plot_centre_Y_coord], your_plot_radius],
                               ['E:/your_point_cloud2.laz', [your_plot_centre_X_coord, your_plot_centre_Y_coord], your_plot_radius]]
    ...
    for point_cloud_filename, plot_centre, plot_radius in point_clouds_to_process:
        parameters = dict(point_cloud_filename=point_cloud_filename,
                          ...
                          MA_margin=0.4,
                          # Cylinder measurements within +/- MA_margin are used for taper measurement at a given height. The average diameter is used.
