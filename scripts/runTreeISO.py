...
if __name__ == '__main__':
    ...
    # point_clouds_to_process = [r'K:\TreeISO\LPine_plot1.laz']
    ...
    if SCAN == 'ALS':
      ...
      scan_param_dict={"denoise_stem_points":False, 
                       ...
                       "SOR_filter" : False, # applies Statistical outlier removal on the slices of stem points                       
                          "gap_connect":.205, # used in dbscan to connect skeleton points into tree skeleton
                          "subsample":0,
                          "headers":['x', 'y', 'z', 'intensity']
                          }
    ...
    for point_cloud_filename in point_clouds_to_process:
        ...
        # try:
           ...
           FSCT(parameters=parameters,
             ...
             preprocess   = 1,  # Preparation for semantic segmentation and denoising
             ...
             clean_up_files=1)  # Optionally deletes most of the large point cloud outputs to minimise storage requirements.
