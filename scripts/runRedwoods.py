...
if __name__ == '__main__':
    ...
    # point_clouds_to_process = ['L:\\APP_hovermap\\APP_radius798_2\\FSCT_work\\E202T19A_orient_trans00.laz']
    # point_clouds_to_process = ['L:\\APP_hovermap\\A212T1A.laz']
    ...
    if SCAN == 'ALS':
      scan_param_dict ={"denoise_stem_points":False, 
                          "tree_base_cutoff_height":8.1, # # to ignore unassigned branches
                          "max_search_radius":3, # search radius (in metres) for interpolation
                          "gap_connect":.4, # number of "slice_increment" gaps to ignore when building a tree
      ...
      scan_param_dict={"denoise_stem_points":True, 
                          "tree_base_cutoff_height":4.1, # to ignore unassigned branches
                          "max_search_radius":4, # search radius (in metres) for interpolation
                          "gap_connect":.6, # used in dbscan to connect skeleton points into tree skeleton
